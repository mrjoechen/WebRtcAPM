package com.chenqiao.webrtcapm.demo;
...
import com.chenqiao.webrtcapm.MP3lame;
import com.chenqiao.webrtcapm.demo.R;
import com.chenqiao.webrtcapm.Ticker;
import com.chenqiao.webrtcapm.WebRtcJni.WebRtcAecm;
import com.chenqiao.webrtcapm.WebRtcJni.WebRtcAgc;
import com.chenqiao.webrtcapm.WebRtcJni.WebRtcNs;
import com.chenqiao.webrtcapm.WebRtcJni.WebRtcVad;
...
public class MainActivity extends AppCompatActivity implements AudioCapturer.OnAudioCapturedListener{
    ...
    public void onClick_record(View view) {
        if (sw_record.isChecked()){
            ...
            mp3 = new MP3lame(SAMPLE_RATE, 2, SAMPLE_RATE,128,0);
