...
#define JNI_API(retType, funName, ...) extern "C"  JNIEXPORT retType Java_com_chenqiao_webrtcapm_Faac_##funName(JNIEnv* env, jclass cls,__VA_ARGS__)
#define JNI_API1(retType, funName) extern "C"  JNIEXPORT retType Java_com_chenqiao_webrtcapm_Faac_##funName(JNIEnv* env, jclass cls)
